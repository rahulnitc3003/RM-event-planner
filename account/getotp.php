...
<?php
    ...
    if (isset($_POST['submitMobile'])) {
        ...
        if($row==0) {
            ...
            $query1 = "update user SET verification_code= '$otpValue', otp_generate_time = '$generateDate'  WHERE user_id = '$user_id'";
            // echo $query1;
            // exit;
    ...
    if(isset($_POST['submitOtp'])) {
        ...
        $query2 = "SELECT * FROM `user` WHERE verification_code = '$otp' and CURRENT_TIMESTAMP() - otp_generate_time <= 1500";
        // echo $_POST['mobile'];
        // exit;
